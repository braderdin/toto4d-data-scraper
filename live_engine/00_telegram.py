...
DESCRIPTION  : Membaca fail JSON cadangan formula (18 & 20) di folder live_engine/temp/
               dan menghantar 2 notifikasi berasingan berformat kemas ke Telegram.
...
# Muat turun pembolehubah dari .env.local atau .env jika wujud
...
# Laluan fail input JSON bagi kedua-dua formula
...
def process_and_send():
    print("=" * 80)
    print(" 🚀 MEMULAKAN PENGHANTARAN NOTIFIKASI TELEGRAM (LIVE ENGINE)")
    print("=" * 80)
    ...
    # Jeda 1.5 saat antara mesej untuk kestabilan penghantaran
    time.sleep(1.5)
    ...
    print("=" * 80)
    print(" ✨ Selesai penghantaran notifikasi!")
    print("=" * 80)
